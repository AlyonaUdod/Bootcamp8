...
let input1 = document.querySelector('#mail');
...
let stringInput = input1.nodeValue;


function getEmail () {
    let stringInput = input1.value;
    console.log(stringInput);
    let regExp = /^[a-zA-Z0-9]+@\w{2,5}(\.com)/gi
    if (!regExp.test(stringInput)) {
        console.log('Почта неправильная');
    } else {
        console.log("Happy");
    }
}
